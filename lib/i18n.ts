...
const fr = {
  ...
  "faq.a3": "Créez un compte, publiez votre produit en quelques minutes. C'est gratuit — la plateforme prélève 10 % par vente (6 % pour les vendeurs Elite), arrondis à la gourde la plus proche.",
...
const ht: Record<I18nKey, string> = {
  ...
  "faq.a3": "Kreye yon kont, pibliye pwodui ou an kèk minit. Li gratis — platfòm nan pran 10 % sou chak vant (6 % pou vandè Elite), awondi nan goud ki pi pre a.",
