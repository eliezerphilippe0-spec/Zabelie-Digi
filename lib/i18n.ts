...
const fr = {
  ...
  "testi.1.n": "Woodley P.",
  "testi.1.b": "Très bon contenu, explications limpides. Terminé en 3 semaines, et je m'en sers tous les jours.",
  "testi.2.n": "Fabiola M.",
...
const ht: Record<I18nKey, string> = {
  ...
  "testi.1.n": "Woodley P.",
  "testi.1.b": "Trè bon kontni, eksplikasyon yo klè anpil. Mwen fini l an 3 semèn, e m ap sèvi avè l chak jou.",
  "testi.2.n": "Fabiola M.",
