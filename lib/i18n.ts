...
const fr = {
  ...
  "sec.cats.explore": "Explorer par catégorie",
  "sec.new": "Nouveautés",
  ...
  "why.1.b": "Chaque paiement reste en escrow jusqu'à ce que l'acheteur confirme la remise. Montant contrôlé en base, jamais sur parole.",
  ...
  "why.4.b": "Interface en kreyòl, en français, en anglais et en espagnol, pages ultra-légères pour la 3G et les petits téléphones.",
  ...
  "sec.digital.sub": "Templates, beats, formations — téléchargement immédiat après paiement.",
  "home.empty.digital": "Aucun fichier digital publié pour l'instant. Soyez le premier à vendre le vôtre.",
  "home.empty.services": "Aucun service publié pour l'instant. Proposez le vôtre.",
  "rail.shop.t": "Ouvrez votre boutique en ligne",
  "rail.shop.free": "0 HTG pour ouvrir",
  "trust.1.t": "Paiement sécurisé avec MonCash",
  "trust.1.b": "Confirmé par le serveur, jamais par le navigateur",
  "trust.2.t": "Votre argent est gardé",
  "trust.2.b": "Le vendeur n'est payé qu'après la remise",
  "trust.3.t": "Prix en gourdes",
  "trust.3.b": "Aucune conversion surprise au paiement",
  "trust.4.t": "Sans compte bancaire",
  "trust.4.b": "MonCash suffit pour acheter et vendre",
  "trust.5.t": "Aide sur WhatsApp",
  "trust.5.b": "Une vraie personne vous répond",
...
const ht: Record<I18nKey, string> = {
  ...
  "sec.cats.explore": "Gade pa kategori",
  ...
  "why.1.b": "Chak peman rete an escrow jiskaske achtè a konfime li resevwa l. Montan an kontwole nan baz done a, pa sou pawòl.",
  "why.3.t": "Peman lakay",
  "why.3.b": "MonCash an goud, Zelle an dola pou dyaspora a. Fèt pou Ayiti anvan tout bagay.",
  "why.4.t": "Kreyòl + leje",
  "why.4.b": "Entèfas an kreyòl, franse, anglè ak panyòl, paj yo leje anpil pou 3G ak ti telefòn yo.",
  ...
  "sec.digital.sub": "Modèl, beat, fòmasyon — telechaje touswit apre peman.",
  "home.empty.digital": "Poko gen fichye dijital. Vin premye vandè a.",
  "home.empty.services": "Poko gen sèvis pibliye. Pwopoze pa w la.",
  "rail.shop.t": "Louvri boutik ou an liy",
  "rail.shop.free": "0 HTG pou louvri",
  "trust.1.t": "Peman an sekirize ak MonCash",
  "trust.1.b": "Se sèvè a ki konfime, pa navigatè a",
  "trust.2.t": "Lajan ou byen gade",
  "trust.2.b": "Vandè a pa touche anvan li remèt li",
  "trust.3.t": "Pri an gourd",
  "trust.3.b": "Pa gen sipriz nan konvèsyon",
  "trust.4.t": "San kont labank",
  "trust.4.b": "MonCash sifi pou achte ak vann",
  "trust.5.t": "Èd sou WhatsApp",
  "trust.5.b": "Se yon moun tout bon k ap reponn ou",
...
const en = {
  ...
  "sec.cats.explore": "Browse by category",
  ...
  "why.1.b": "Every payment stays in escrow until the buyer confirms handover. Amounts checked in the database, never taken on trust.",
  ...
  "why.4.b": "Interface in Kreyòl, French, English and Spanish, ultra-light pages for 3G and small phones.",
  ...
  "sec.digital.sub": "Templates, beats, courses — instant download after payment.",
  "home.empty.digital": "No digital files published yet. Be the first to sell yours.",
  "home.empty.services": "No services published yet. Offer yours.",
  "rail.shop.t": "Open your online shop",
  "rail.shop.free": "0 HTG to open",
  "trust.1.t": "Secure payment with MonCash",
  "trust.1.b": "Confirmed by the server, never by the browser",
  "trust.2.t": "Your money is held",
  "trust.2.b": "The seller is paid only after handover",
  "trust.3.t": "Prices in gourdes",
  "trust.3.b": "No surprise conversion at checkout",
  "trust.4.t": "No bank account needed",
  "trust.4.b": "MonCash is enough to buy and sell",
  "trust.5.t": "Help on WhatsApp",
  "trust.5.b": "A real person answers you",
...
const es = {
  ...
  "sec.cats.explore": "Explora por categoría",
  "sec.new": "Novedades",
  ...
  "why.1.b": "Cada pago queda en depósito hasta que el comprador confirma la entrega. Monto comprobado en base de datos, nunca de palabra.",
  "why.3.t": "Pago lakay",
  ...
  "sec.digital.sub": "Plantillas, beats, cursos — descarga inmediata tras el pago.",
  "home.empty.digital": "Aún no hay archivos digitales. Sé el primero en vender el tuyo.",
  "home.empty.services": "Aún no hay servicios publicados. Ofrece el tuyo.",
  "rail.shop.t": "Abre tu tienda en línea",
  "rail.shop.free": "0 HTG para abrir",
  "trust.1.t": "Pago seguro con MonCash",
  "trust.1.b": "Confirmado por el servidor, nunca por el navegador",
  "trust.2.t": "Tu dinero está retenido",
  "trust.2.b": "El vendedor cobra solo tras la entrega",
  "trust.3.t": "Precios en gourdes",
  "trust.3.b": "Sin conversión sorpresa al pagar",
  "trust.4.t": "Sin cuenta bancaria",
  "trust.4.b": "MonCash basta para comprar y vender",
  "trust.5.t": "Ayuda por WhatsApp",
  "trust.5.b": "Una persona real te responde",
