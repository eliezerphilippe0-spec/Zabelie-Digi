...
const fr = {
  ...
  "cart.remove": "Retirer",
  "cart.total": "Total",
  "cart.note": "Le paiement groupé arrive bientôt — en attendant, chaque article se paie depuis sa page.",
...
const ht: Record<I18nKey, string> = {
  ...
  "cart.remove": "Retire",
  "cart.total": "Total",
  "cart.note": "Peman gwoupe ap vini talè — pou kounye a, chak atik peye sou paj pa li.",
...
const en = {
  ...
  "cart.remove": "Remove",
  "cart.total": "Total",
  "cart.note": "Grouped payment is coming soon — for now each item is paid from its page.",
...
const es = {
  ...
  "cart.remove": "Quitar",
  "cart.total": "Total",
  "cart.note": "El pago agrupado llega pronto — por ahora cada artículo se paga desde su página.",
