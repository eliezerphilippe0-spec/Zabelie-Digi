      ...
      <section className="mx-auto max-w-6xl px-5 pb-10 pt-16">
        <div className="flex items-center gap-5">
          {creator.avatarUrl ? (
            ...
            <span className="grid h-20 w-20 place-items-center rounded-2xl bg-gradient-to-br from-gold to-violet text-2xl font-extrabold text-on-brand">
              {initials}
            </span>
          )}
          <div>
