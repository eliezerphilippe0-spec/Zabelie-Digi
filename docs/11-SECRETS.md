...
| `ZABELIE_JEV_TRIAGE_ENABLED` | `true` (valeur exacte) envoie chaque message de support à Jev en **observation** (docs/61 §8) ⚠️ **données clients vers un tiers** : ne pas poser avant l'avis du Cabinet Volmar sur la rétention, ni avant l'application de `0114` |
