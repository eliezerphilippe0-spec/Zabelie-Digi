...
| 4 | MAJEUR | `lib/i18n-server.ts:8` | Langue par défaut **`"fr"`** sans cookie. Un produit annoncé kreyòl-first sert le français à tout visiteur nouveau — et à tout crawler (`docs/47` §3). | Défaut `"ht"`, ou langue dans l'URL (`docs/47` §3, arbitrage porteur). |
